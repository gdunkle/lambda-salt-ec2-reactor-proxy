...
ZIP_FILE_NAME="lambda-salt-ec2-reactor-proxy-$timestamp.zip"
LAYER_FILE_NAME="lambda-salt-ec2-reactor-proxy-layer-$timestamp.zip"
cd ..
...
echo "------------------------------------------------------------------------------"
echo "[Build] lambda_sns_listener Function"
echo "------------------------------------------------------------------------------"
cd $source_dir
...
echo "------------------------------------------------------------------------------"
echo "[Build] lambda-salt-ec2-reactor-proxy Layer"
echo "------------------------------------------------------------------------------"

DEPENDENCY_EXCLUDE_LIST=${OVERRIDE_DEFAULT_DEPENDENCY_EXCLUDE_LIST:=["aws_cdk","lambda_sns_listener","boto3","dist-info","pip","botocore","jsii","docutils","pkg_resources","setuptools","test","tests","s3transfer"]}
